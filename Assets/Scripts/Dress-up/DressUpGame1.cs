...
public class DressUpGame1 : MonoBehaviour
{
    ...
    [Tooltip("Scene to load when Done is clicked")]
    public string doneSceneName = "Crawfish";
    ...
    public void OnDoneClicked()
    {
        ...
        SceneManager.LoadScene(doneSceneName);
    }
}